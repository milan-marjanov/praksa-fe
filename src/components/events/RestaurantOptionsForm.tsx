// components/RestaurantOptionsForm.tsx
...
interface RestaurantOptionsFormProps {
  ...
  eventStartTime?: string; // Used to validate deadline externally
}

const RestaurantOptionsForm: React.FC<RestaurantOptionsFormProps> = ({
  votingEnabled,
  onVotingToggle,
  restaurantOptions,
  onAddOption,
...
export default RestaurantOptionsForm;
